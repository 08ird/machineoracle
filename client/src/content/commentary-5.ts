/** Part V — Machine Oracle. Plus the front and back matter of the piece. */

import type { Block } from './types';

export const part5: Record<number, Block[]> = {
  39: [
    {
      kind: 'p',
      lead: true,
...
/** Front matter — the sections before Part I. */
export const front: Record<number, Block[]> = {
  2: [
    {
      kind: 'p',
      lead: true,
  ...
  5: [
    {
      kind: 'p',
      text:
        'Five parts, one thesis. Part I names the era. Part II quantifies the phenomenon and shows where it lands. Part III is the receipts — dated, named, and already in the filings, because this is not a futurist document. Part IV is the conclusion and the portfolio that follows from it. Part V is our sensing edge, the assumptions we are exposed to, and why the entry is now.',
    },
  ],
};
