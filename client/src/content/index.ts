...
const infiniteSoftware: Piece = {
  ...
  conclusion,
  chapterBlurbs: {
    1: 'For thirty years, humans were the rate limiter on software infrastructure. Agents remove the constraint: the marginal consumer of software becomes software itself. Machine intensity, work expansion, the action multiplier, active time, state, efficiency, monetization — seven variables define the era, and three of them decide whether this is a normal software cycle or an enormous backend cycle.',
