...
const infiniteSoftware: Piece = {
  ...
  chapterBlurbs: {
    ...
    2: 'The model starts from work, not agent counts: workflows × penetration × machine actions × efficiency × billability. Our 2029 base case needs only 20% agent penetration to produce ~2.4x backend workload. The token record is the measured proof of the demand side — ~2,000x growth in four years, every 10x price drop buying 15–20x more demand, and a dated call of ~4,000Q tokens by 2029, still on the curve.',
